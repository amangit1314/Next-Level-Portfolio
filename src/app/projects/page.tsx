...
//             </motion.div>
//             <h2
//               className={`${poppins.className} text-5xl lg:text-6xl font-black bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent leading-tight pb-1`}
//             >
//               Featured Projects
//             </h2>
...
const Projects = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-24 lg:py-32 overflow-hidden px-4 md:px-8 bg-gradient-to-br from-black via-zinc-950 to-purple-950/20"
    >
      {/* Advanced Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <section className="relative py-20 md:py-32 overflow-hidden">
            ...
            <div className="container px-4 mx-auto relative z-10">
              ...
              >
                ...
                {/* Subtitle */}
                <p className="text-xl md:text-2xl text-neutral-400 max-w-3xl mx-auto mb-12 leading-relaxed">
                  Showcasing {PROJECTS.length}+ projects built over 3 years of
                  professional development experience. From enterprise
                  applications to innovative side projects.
                </p>
          ...
          {/* <motion.div variants={itemVariants} className="text-center">
            <Link
              href="/projects"
              className="group relative inline-flex items-center gap-3 px-8 py-4 overflow-hidden rounded-2xl bg-zinc-900/80 backdrop-blur-md border border-purple-500/30 hover:border-purple-400/50 transition-all duration-500"
            >
