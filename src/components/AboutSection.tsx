...
//             <p className="px-4 md:px-0 w-full md:text-base line-clamp-4 text-gray-300">
...
//             {/* Button */}
//             <button className="px-4 py-2 mt-6 text-white transition duration-300 ease-in-out delay-150 bg-purple-600 rounded-lg md:mx-auto xl:ml-12 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500">
//               Contact Me
//             </button>
//           </div>
//         </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 md:px-8 xl:px-20 py-16 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-3xl font-semibold text-white xl:text-4xl">About Me</p>
      </div>
        ...
        <div className="w-full md:w-3/5 space-y-8">
          ...
          <div className="space-y-4">
            <p className="text-sm md:text-base text-gray-300">
              ...
              beautiful UI / UX. With my 3 years of experience building
              projects my clients are happy with, I can provide both assurance
