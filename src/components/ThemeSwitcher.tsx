    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="p-2.5 rounded-lg bg-zinc-800/50 border border-zinc-700/50 hover:border-purple-500/50 transition-all duration-300 group relative"
                aria-label="Change theme"
            >
                <FaPalette className="w-5 h-5 text-zinc-300 group-hover:text-purple-400 transition-colors duration-300" />
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full right-0 mt-2 p-4 bg-zinc-900/95 backdrop-blur-xl rounded-2xl border border-zinc-700/50 shadow-2xl w-80 max-h-[32rem] overflow-y-auto z-50"
                    >
                        <div className="mb-3">
                            <h3 className={`text-sm font-semibold text-white ${poppins.className}`}>
                                Choose Theme
                            </h3>
    ...
    return (
        <motion.button
            ...
            className={`relative p-3 rounded-xl border-2 transition-all duration-300
                  ${isActive
                    ? 'border-white bg-zinc-800/50 shadow-lg'
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                ...
                <span className={`text-xs font-semibold text-white truncate ${poppins.className}`}>
                    {theme.name}
                </span>
            </div>
