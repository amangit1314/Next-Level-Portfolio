...
const ProjectCard = (props: ProjectCardProps) => {
    ...
    >
        ...
        <div className="absolute inset-0 rounded-3xl overflow-hidden">
            <div className="absolute inset-[-2px] bg-gradient-to-r from-purple-500 via-transparent to-indigo-500 opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-700" />
        </div>
        ...
        <div className="relative flex flex-col lg:flex-row">
            ...
            <div className="p-8 lg:p-10 lg:w-1/2 flex flex-col justify-center relative">
                ...
                <Link href={project.link}>
                    <motion.h3 className={`text-3xl md:text-4xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-300 ${unbounded.className}`}>
                        {project.title}
                    </motion.h3>
                </Link>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                    {project.technologies?.map((tech: string, techIndex: number) => (
                        <motion.span
                            ...
                            className={`px-4 py-2 bg-gradient-to-br from-neutral-800/80 to-neutral-900/80 text-neutral-300 rounded-xl border border-neutral-700/50 hover:border-purple-500/50 hover:text-purple-300 transition-all duration-300 text-xs font-medium backdrop-blur-sm ${unbounded.className}`}
                        >
                            {tech}
                        </motion.span>
                    ))}
