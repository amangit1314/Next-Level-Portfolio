...
//   FiBookOpen,
// } from "react-icons/fi";
// import { caveat, inter, unbounded, unbounded } from "@/lib/fonts";
...
//                     className={`flex ${inter.className} cursor-pointer hover:text-theme-primary w-full items-center justify-between text-left text-2xl font-semibold ${
//                       active ? "text-white" : "text-theme-text-muted"
//                     }`}
//                     onClick={() => {
//                       setIsMenuOpen(false);
...
//             {/* <motion.div
//               variants={itemVariants}
//               className="flex justify-between items-center space-x-3 text-xs text-theme-text-muted"
//             >
//               <div className="space-y-1">
//                 <motion.p
//                   className={`font-medium text-md text-theme-text-muted mb-2 ${unbounded.className}`}
//                 >
//                   Social
//                 </motion.p>
//                 <div
//                   className={` ${inter.className} flex flex-wrap gap-4 text-[11px]`}
//                 >
//                   <a
...
//               <div className="space-y-1">
//                 <motion.p
//                   className={`font-medium text-theme-text-muted text-md mb-2 ${unbounded.className}`}
//                 >
//                   Contact
//                 </motion.p>
