...
//                   width={48}
//                   height={48}
//                   className="object-cover rounded-full ring-2 ring-theme-border/50 group-hover:ring-theme-primary/50 transition-all duration-300"
//                 />
//                 <div className="absolute -inset-1 theme-gradient-primary rounded-full opacity-0 group-hover:opacity-20 blur transition-all duration-300" />
//               </div>
//               {/* <div className="flex flex-col">
//                 <span
//                   className={`text-lg md:text-xl font-bold theme-text-gradient bg-clip-text text-transparent tracking-tight ${poppins.className}`}
//                 >
//                   Aman Soni
//                 </span>
//                 <span className="text-xs text-theme-text-muted font-medium tracking-wide">
...
//                     <span className={`text-xs font-bold theme-text-gradient bg-clip-text text-transparent tracking-tight ${poppins.className}`}>{link.name}</span>
//                   </span>

//                   {/* Enhanced Active Indicator */}
//                   {activeSection === link.path.substring(1) && (
//                     <motion.div
//                       className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-theme-primary/20"
//                       layoutId="activeNav"
//                       transition={{
//                         type: "spring",
//                         stiffness: 300,
...
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//               className="group relative px-6 py-2.5 text-sm font-semibold text-white theme-gradient-accent rounded-lg shadow-lg hover:shadow-purple-500/25 transition-all duration-300"
//             >
//               <span className="relative z-10 flex items-center space-x-2">
//                 <span className={`text-xs font-bold theme-text-gradient bg-clip-text text-transparent tracking-tight ${poppins.className}`}>Resume</span>
...
//           ? "bg-theme-bg-primary/95 backdrop-blur-xl border-b border-theme-border/50"
//           : "bg-transparent"
//           }`}
//       >
...
//                 width={36}
//                 height={36}
//                 className="object-cover rounded-full ring-1 ring-theme-border/50"
//               />
//               <span
                ...
                return (
                  ...
                  >
                    <span className="relative z-10 flex items-center space-x-2">
                      <link.icon className="w-4 h-4" />
                      <span
                        className={`text-xs font-bold theme-text-gradient bg-clip-text text-transparent tracking-tight ${poppins.className}`}
                      >
                        {link.name}
                      </span>
                    </span>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="relative">
                <motion.div
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-theme-bg-secondary ring-2 ring-zinc-700/50 group-hover:ring-purple-500/70 transition-all duration-300 overflow-hidden"
                  whileHover={{ rotate: 2 }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                >
                  <span
                    className={`${caveat.className} text-lg font-semibold tracking-wide theme-gradient-accent bg-[length:200%_200%] bg-clip-text text-transparent transition-all duration-300 group-hover:animate-gradient-x`}
                  >
                    As
                  </span>
                </motion.div>
                <div className="pointer-events-none absolute -inset-1 rounded-full theme-gradient-accent opacity-0 blur group-hover:opacity-100 transition-all duration-500" />
              </div>
            </motion.div>
            {/* Animated Menu Icon */}
            <motion.button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-theme-bg-secondary border border-theme-border/70 text-theme-text-primary"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between px-5 py-4 border-b border-theme-border">
            <span
              className={`text-base font-semibold text-theme-text-primary ${poppins.className}`}
            >
              Menu
            </span>
            <motion.button
          ...
          <div className="flex h-[calc(100%-56px)] flex-col justify-between px-6 py-6">
              ...
              {pageLinks.map((link, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`flex w-full items-center justify-between text-left text-2xl font-semibold ${active ? "text-white" : "text-theme-text-muted"
                      }`}
                    onClick={() => {
                      setIsMenuOpen(false);
            ...
            <motion.div
              variants={itemVariants}
              className="space-y-3 text-xs text-theme-text-muted"
            >
              <div className="space-y-1">
                <p className="font-medium text-theme-text-muted">Social</p>
              ...
              <div className="space-y-1">
                <p className="font-medium text-theme-text-muted">Contact</p>
