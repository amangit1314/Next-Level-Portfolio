...
//         >
//           {/* Timeline line */}
//           <div className="absolute left-4 md:left-[calc(25%-5px)] top-0 h-full w-0.5 bg-gradient-to-b from-purple-500/20 via-purple-500/50 to-purple-500/20"></div>
...
//               >
//                 {/* Timeline dot */}
//                 <div className="absolute left-0 md:left-[calc(25%-10px)] top-1 w-5 h-5 rounded-full bg-purple-500 border-4 border-neutral-950 z-10"></div>

//                 <div className="flex flex-col md:flex-row gap-6">
//                   {/* Year - now properly spaced in its own column */}
...
//                   <div className="md:w-3/4 bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 rounded-xl p-6 space-y-4">
//                     <h3 className="text-xl font-bold text-white">
//                       {experience.role}
//                       <span className="text-base font-normal text-pink-300 block md:inline">
//                         {" "}@{" "}
//                         <Link
          ...
          {EXPERIENCES.map((experience, index) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                {/* Content card */}
                <div className="relative md:w-3/4 bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 rounded-xl p-6 space-y-4 group hover:border-pink-400/30 transition-all duration-300">
                  <h3 className="text-xl font-bold text-white">
                    {experience.role}
                    <span className="text-base font-normal text-pink-300 block md:inline">
                      {" "}@{" "}
