...
export default function TestimonialItem({
  ...
  return (
    <div className="flex-col items-center p-6 m-6 cursor-pointer rounded-xl w-100 align-center bg-slate-800 bg-opacity-80 bg-clip-padding backdrop-filter-blur">
      <div className="flex justify-start mb-6 w-100">
        ...
        <figcaption class="ml-4 py-1 font-medium">
          ...
          <div class="text-slate-500 line-clamp-2 text-sm">
            {role}
          </div>
        </figcaption>
      </div>
