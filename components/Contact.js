  ...
  return (
    <div>
      <section className="p-8 mx-auto my-24 text-gray-800 max-w-7xl">
        {/* Contact Text */}
        <h1 className="text-3xl font-bold text-white md:text-center md:mx-auto ">Contact Me</h1>

        {/* Contact Section description */}
        <h3 className="w-auto mt-4 text-white xl:text-center md:mx-auto">
          Send a mail to me htmlFor contacting, or you can use below social
          handles
        </h3>
              ...
              <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto xl:w-5/12 lg:px-6 xl:mb-0">
                ...
                <form>
                  <div className="mb-6 htmlForm-group">
                    <input
                      type="text"
                      className="htmlForm-control block w-full px-3 py-1.5 text-base font-normal text-gray-700  bg-white bg-clip-padding border border-solid border-gray-300 rounded  transition ease-in-out m-0  focus:text-gray-700 focus:bg-white focus:border-purple-600 focus:outline-none"
                      id="exampleInput7"
                      placeholder="Name"
                    />
                  </div>
                ...
                border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-purple-600 focus:outline-none"
                      id="exampleInput8"
                  ...
                  <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto md:w-6/12 lg:px-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4 grow">
                        ...
                        <p className="text-gray-500 w-[2rem]">gitaman8481@gmail.com</p>
                  ...
                  <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto md:w-6/12 lg:px-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4 grow">
                        ...
                        <p className="text-gray-500 text-ellipsis overflow-clip">Rajasthan, India</p>
