...
function HeroSection() {
  return (
    <div className="mr-24 ml-24">
      <section
        id="hero-sect"
        className="h-80 w-100 flex flex-row justify-between"
      >
        <div className="devInfo mt-20 flex flex-1 flex-col">
          <div className="about  w-9/12 font-semibold mt-8 text-4xl text-green-100 mobile:text-blue-400 tablet:text-red-400 desktop:text-yellow-400 monitor:text-green-400">
          ...
          <svg
            className="down-arrow bottom-12 w-4 mt-24  absolute stroke-black animate-bounce mobile:hidden"
            viewBox="0 0 16 132"
            fill="none"
